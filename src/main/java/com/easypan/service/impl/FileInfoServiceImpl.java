...
public class FileInfoServiceImpl implements FileInfoService {
    ...
    public UploadResultDto uploadFile(SessionWebUserDto webUserDto, String fileId,
        ...
        try {
            ...
            String tempFolderName =
                    appConfig.getProjectFolder() + Constants.FILE_FOLDER_TEMP;
    ...
    //判断是否重复
    private void  checkFileName(String filePid, String userId, String fileName,Integer folderTypr){
        FileInfoQuery fileInfoQuery = new FileInfoQuery();
        fileInfoQuery.setFolderType(folderTypr);
        fileInfoQuery.setUserId(userId);
        fileInfoQuery.setFilePid(filePid);
        fileInfoQuery.setFileName(fileName);
        fileInfoQuery.setDelFlag(FileDelFlagEnums.USING.getFlag());
    ...
    public void transferFile(String fileId,SessionWebUserDto webUserDto){
        ...
        try{
            ...
            logger.error("合并转码失败,文件I:{},userID:{}",fileId,webUserDto.getUserId(),e);
    ...
    public PaginationResultVO<FileInfo> findListByPage(FileInfoQuery param) {
        ...
        int pageSize = param.getPageSize() == null ? PageSize.SIZE15.getSize() :
                param.getPageSize();
